...
aws_url = "http://travistest-env.q2squxuwmv.us-east-1.elasticbeanstalk.com"
...
class TestWeb:
    ...
    def test_home(self):
        ...
        # Test GET on root
        response = application.test_client().get(aws_url + "/")
    ...
    def test_404(self):
        response = application.test_client().get(aws_url + "/badroute")
        assert(response.status_code == 404)   
 
    def test_bad_req(self):
    
        # Test non numerical input number
        response = application.test_client().post(aws_url + "/", 
